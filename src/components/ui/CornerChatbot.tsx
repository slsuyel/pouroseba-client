    ...
    if (inputValue.trim()) {
      ...
      setTimeout(() => {
        ...
        if (["hi", "hello", "hey", "হাই", "হ্যালো"].includes(lowerCaseInput)) {
          ...
          botResponse =
            "আপনি আমাদের <a href='/contact' target='_blank'>যোগাযোগ পৃষ্ঠা</a> ভিজিট করে বা <a href='mailto:support@uniontax.gov.bd'>support@uniontax.gov.bd</a> ইমেইল করে আমাদের সাপোর্ট টিমের সাথে যোগাযোগ করতে পারেন। লাইভ বা বিশেষ সহায়তার জন্য লগ ইন বা রেজিস্টার করুন।";
        } else {
